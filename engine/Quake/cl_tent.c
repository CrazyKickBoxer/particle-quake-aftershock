...
static void CL_ParseBeam (qmodel_t *m, const char *trailname, const char *impactname)
{
	...
	if(!strcmp(trailname,"TE_LIGHTNING1") || !strcmp(trailname,"TE_LIGHTNING2") || !strcmp(trailname,"TE_LIGHTNING3")) HP_Beam(start,end);
