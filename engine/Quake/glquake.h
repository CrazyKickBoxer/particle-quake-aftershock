...
typedef struct
{
    ...
    vulkan_pipeline_layout_t holo_world_layout;
    vulkan_pipeline_t holo_gore[MAIN_RENDER_PASS_VARIANT_COUNT];
    vulkan_pipeline_t holo_structure[MAIN_RENDER_PASS_VARIANT_COUNT][2];
    vulkan_pipeline_t holo_splat[MAIN_RENDER_PASS_VARIANT_COUNT][2];
	vulkan_pipeline_t		 raster_tex_warp_pipeline;
	vulkan_pipeline_t		 particle_pipeline;
	vulkan_pipeline_t aftershock_structure[MAIN_RENDER_PASS_VARIANT_COUNT][2];
	vulkan_pipeline_t aftershock_splat[MAIN_RENDER_PASS_VARIANT_COUNT][2];
	vulkan_pipeline_t aftershock_alias[MAIN_RENDER_PASS_VARIANT_COUNT][2];
	vulkan_pipeline_t aftershock_fx[MAIN_RENDER_PASS_VARIANT_COUNT],aftershock_fx_oit,aftershock_fx_moment,aftershock_fx_composite;
	vulkan_pipeline_t aftershock_solid[MAIN_RENDER_PASS_VARIANT_COUNT];
